...
class CategoryDetail extends Component {
  ...
  openDeleteFlowerProducts = () => {
    this.setState({
      openDeleteFlowerProducts: !this.state.openDeleteFlowerProducts,
    })
  }

  updateCategory = async (active) => {
    try {
  ...
  render() {
    const { detailCategory, redirect, loadingDetailSchedule, name, price, description, openEditFlowerProducts, isLoadingEdit, openDeleteFlowerProducts, isLoadingConfirmDone} = this.state;
    if (redirect) {
